...
fetch("http://localhost:8080/api/total-boxes/")
  ...
  .then((data) => {
    ...
    const rackCapacities = document.getElementById("rackCapacities");

    // Define floor and rack names for the 1st floor
    const floorRackNames = [
      { floor: "1st Floor", rack: "Rack 1" },
      { floor: "1st Floor", rack: "Rack 2" },
      { floor: "1st Floor", rack: "Rack 3" },
      { floor: "1st Floor", rack: "Rack 4" },
      { floor: "1st Floor", rack: "Floor" },
    ];
